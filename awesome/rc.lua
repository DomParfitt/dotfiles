...
globalkeys = gears.table.join(
    ...
    -- Navigate between tags (workspaces)      
    awful.key({ modkey, "Control" }, "Left", awful.tag.viewprev,
              {description = "view previous", group = "tag"}),
    awful.key({ modkey, "Control" }, "Right", awful.tag.viewnext,
              {description = "view next", group = "tag"}),

    -- Navigate windows in current workspace
    ...
    awful.key({ modkey, "Shift" }, "Up", 
        ...
        {description = "Swap current window with window to the up", group = "client"}
    ),
    awful.key({ modkey, "Shift" }, "Down", 
        function() 
            awful.client.swap.bydirection("down") 
        end,
        {description = "Swap current window with window to the down", group = "client"}
    ),

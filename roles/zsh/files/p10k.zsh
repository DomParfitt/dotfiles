# Generated by Powerlevel10k configuration wizard on 2020-01-27 at 08:53 GMT.
# Based on romkatv/powerlevel10k/config/p10k-lean.zsh, checksum 24440.
...
() {
  ...
  ###############################[ public_ip: public IP address ]###############################
  # Public IP color.
  typeset -g POWERLEVEL9K_PUBLIC_IP_FOREGROUND=105
  # Custom icon.
